...
<div class="main-content">
    <section class="section">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="post" action="{{route('master_siswa.simpanfoto', request()->id)}}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row py-4">
                    <div class="col-lg-6">
                        ...
                        <div class="image-area mt-4"><img src="{{  asset('storage/assets/img/avatar/'.$siswa->foto) }}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
                    </div>
                    <div class="col-lg-6">
