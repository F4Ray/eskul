            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ setActive('master_siswa/*/ubahpassword') }} "><a class="nav-link" href="{{ route('master_siswa.lihatpassword', Auth::user()->siswa->id) }}"><i class="fas fa-key"></i>Ubah Password</a>
                        </li>
